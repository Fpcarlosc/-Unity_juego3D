...
public class JugadorVida : MonoBehaviour
{
    ...
    private JugadorDisparo jugadorDisparo; // Referencia al script JugadorDisparo.cs.
    ...
    void Awake ()
    {
        ...
        jugadorDisparo = GetComponentInChildren <JugadorDisparo> (); // Accedemos al hijo ya que el script está asociado a GunBarrelEnd.
    ...
    void Muerte ()
    {
        ...
        // Deshabilitamos el efectos del disparo.
        jugadorDisparo.DeshabilitarEfectos ();
        ...
        // Deshabilitamos el script MovimientoJugador.cs y JugadorDisparo.cs.
        movimientoJugador.enabled = false;
        jugadorDisparo.enabled = false;
    }    

    // Método para volver a empezar cuando el jugador muere.
